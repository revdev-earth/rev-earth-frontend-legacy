...
export const ComponentRef = styled.div`
  ...
  ${({
    animation
  }) => animation.includes('slide') && animations.slide}
  ${({ animation }) =>
    animation.includes('flip') && animations.flip}
  ...
  &.animate {
    ...
    ${({ animation }) =>
      animation.includes('zoom') && animations.zoom.animate}
    ${({
      animation
    }) => animation.includes('slide') && animations.slide.animate}
    ${({
      animation
    }) => animation.includes('flip') && animations.flip.animate}
  }
`
