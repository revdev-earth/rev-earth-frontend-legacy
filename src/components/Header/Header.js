  ...
  return (
    <Headroom>
      <Container theme={theme} headerType={headerType}>
        ...
        {/* <MenuHeader headerType={headerType} /> */}

        <BoxLineComponent headerType={headerType} />
      </Container>
    </Headroom>
  );
};

const BoxLineComponent = ({headerType}) => (
  <BoxLine className="box-line">
    <GridBoxLine headerType={headerType}>
      <ContainerLogo headerType={headerType}>
...
const MenuHeader = ({headerType}) => {
  return (
    <Menu>
      <ContainerButton>
        <ButtonMenu aria-hidden="true" headerType={headerType}>
          <ContainerIcon>
            <svg
              width="24"
              height="24"
